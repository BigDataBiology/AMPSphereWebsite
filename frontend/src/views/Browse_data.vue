<template>
  <div class="BrowseData">
    ...
    <!--          </el-select>-->
    <!--&lt;!&ndash;          TODO MEDIUM PRIORITY: change this filter into peptide length&ndash;&gt;-->
    ...
    <!--          </el-select>-->
    <!--&lt;!&ndash;          <el-button @click="clearFilters" type="primary"><span>Clear</span></el-button>&ndash;&gt;-->
    <!--          </span>-->
    <!--          <el-table :data="amps" stripe style="width: 100%"-->
    <!--                    v-loading="isloading"-->
    <!--                    element-loading-text="Loading..."-->
